...
public class SMap<String, Object> extends HashMap<String, Object> {
	...
	public SMap<String, Object> getHMap(String key){
		SMap<String, Object> rtn = null;
		
		try {
			rtn = (SMap<String, Object>) super.get(key);
		}catch(Exception e) {
			rtn = new SMap();
		}
	...
	public List<SMap<String, Object>> getListHMap(String key){
		List<SMap<String, Object>> rtn = null;
		
		try {
			rtn = (List<SMap<String, Object>>) super.get(key);
		}catch(Exception e) {
			rtn = new ArrayList();
		}
